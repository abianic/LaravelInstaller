...
namespace Abianic\LaravelInstaller\Controllers;

use Illuminate\Routing\Controller;
use Abianic\LaravelInstaller\Events\LaravelInstallerFinished;
use Abianic\LaravelInstaller\Helpers\EnvironmentManager;
use Abianic\LaravelInstaller\Helpers\FinalInstallManager;
use Abianic\LaravelInstaller\Helpers\InstalledFileManager;
...
class FinalController extends Controller
{
     ...
     *
     * @param \Abianic\LaravelInstaller\Helpers\InstalledFileManager $fileManager
     * @param \Abianic\LaravelInstaller\Helpers\FinalInstallManager $finalInstall
     * @param \Abianic\LaravelInstaller\Helpers\EnvironmentManager $environment
